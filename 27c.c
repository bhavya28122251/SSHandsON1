...
execle("/bin/ls","ls","-Rl",NULL,en);

perror("There is an error in executing execle system call\n");
...
/*Output:
bhavya@Bhavya:~/SSHandsOn1$ gcc 27c.c
...
-rw-rw-r-- 1 bhavya bhavya   379 Aug 30 15:13 27c.c
-rw-rw-r-- 1 bhavya bhavya   354 Aug 30 15:07 27d.c
...
-rwxrwxr-x 1 bhavya bhavya 16048 Aug 30 15:13 a.out
